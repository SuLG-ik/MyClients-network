...
class CustomerNotExists(val credentials: String) : NetworkException() {
    override val httpStatusCode: HttpStatusCode
...
class CardNotExists(val credentials: String) : NetworkException() {
    override val httpStatusCode: HttpStatusCode
        get() = HttpStatusCode.NotFound
}
...
@Serializable
@SerialName("company_not_exists")
class CompanyNotExists(
...
class AccountNotExists(val credentials: String) : NetworkException() {
    override val httpStatusCode: HttpStatusCode
        get() = HttpStatusCode.NotFound
}
...
class AccountAlreadyDeactivated(val accountId: AccountId) : NetworkException() {
    override val httpStatusCode: HttpStatusCode
        get() = HttpStatusCode.NotFound
}
...
@Serializable
@SerialName("customers_storage_not_exists")
class CustomersStorageNotExists(val credentials: String) : NetworkException() {
    override val httpStatusCode: HttpStatusCode
        get() = HttpStatusCode.NotFound
}