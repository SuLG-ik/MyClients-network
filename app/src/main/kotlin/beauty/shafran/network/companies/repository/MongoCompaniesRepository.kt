...
//
//    init {
//        SchemaUtils.createMissingTablesAndColumns(CompaniesTable, CompaniesDataTable)
//    }
//
//    override suspend fun throwIfBusinessNotExists(companyId: String) {
//        if (!businessesCollection.isDocumentExists(CompanyEntity::id eq companyId.toIdSecure("businessId"))) {
...
//        data: CompanyStationEntityData,
//        location: CompanyStationEntityLocation,
//        companyId: String,
//    ): CompanyStationEntity {
